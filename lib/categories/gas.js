...
function parseRatesResponse(data) {
    ...
    return {
        gas_unit_rate: tariff.unitRate != null ? parseFloat(tariff.unitRate) : null,
        gas_standing_charge: tariff.standingCharge != null ? parseFloat(tariff.standingCharge) : null,
