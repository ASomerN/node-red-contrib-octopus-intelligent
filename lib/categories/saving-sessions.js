...
function parseResponse(data) {
    ...
    const isJoined = nextEvent ? joinedIds.includes(nextEvent.id) : false;

    return {
        saving_session_available: events.length > 0,
        saving_session_start: nextEvent ? nextEvent.startAt : null,
        saving_session_end: nextEvent ? nextEvent.endAt : null,
...
const defaultData = {
    ...
    saving_session_joined: null, saving_sessions_error: null
};
