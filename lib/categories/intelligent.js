...
function parseResponse(data, { tz, serverTz }) {
    ...
    const totalEnergy = active.reduce((sum, s) => sum + (s.energyAddedKwh || 0), 0);
    ...
    return {
        ...
        next_kwh: nextSlot ? (nextSlot.energyAddedKwh != null ? String(parseFloat(nextSlot.energyAddedKwh.toFixed(2))) : '0') : '0',
